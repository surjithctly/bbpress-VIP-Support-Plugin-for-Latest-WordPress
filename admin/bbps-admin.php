...
*/
		...
		add_settings_field( '_bbps_enable_trusted_tag', __( 'Show Badge', 'bbps-forum' ), 'bbps_admin_setting_callback_trusted_tag',      'bbpress', 'bbps-forum-setting' );
	 	register_setting  ( 'bbpress', '_bbps_enable_trusted_tag', 'intval');
		...
		register_setting  ( 'bbpress', '_bbps_used_status_1', 'intval' );
		...
		register_setting  ( 'bbpress', '_bbps_used_status_2', 'intval' );
		...
		register_setting  ( 'bbpress', '_bbps_used_status_3', 'intval' );
		...
		register_setting  ( 'bbpress', '_bbps_status_permissions_admin', 'intval' );
		// each drop down option for selection
		...
		register_setting  ( 'bbpress', '_bbps_status_permissions_user', 'intval' );
		...
		register_setting  ( 'bbpress', '_bbps_status_permissions_moderator', 'intval' );

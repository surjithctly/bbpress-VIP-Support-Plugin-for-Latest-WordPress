...
function bbps_admin_setting_callback_trusted_tag(){
?>
	<input id="bbps_enable_trusted_tag" name="_bbps_enable_trusted_tag" type="checkbox" <?php checked( bbps_is_trusted_tag_enabled(),1 ); ?> value="1" />
	<label for="_bbps_enable_trusted_tag"><?php _e( 'Show Author / Staff Badge below Avatar?', 'bbpress' ); ?></label>
<?php
}
...
?>
	<input id="bbps_used_status" name="_bbps_used_status_1" <?php checked( bbps_is_resolved_enabled(),1 ); ?> type="checkbox"  value="1" checked="" />
	<label for="_bbps_used_status_1"><?php _e( 'Resolved', 'bbpress' ); ?></label>
<?php
}

function bbps_admin_setting_callback_displayed_status_notres(){
?>
	<input id="bbps_used_status" name="_bbps_used_status_2" <?php checked( bbps_is_not_resolved_enabled(),1 ); ?> type="checkbox"  value="1" />
	<label for="_bbps_used_status_2"><?php _e( 'Not Resolved', 'bbpress' ); ?></label>
<?php
}

function bbps_admin_setting_callback_displayed_status_notsup(){
?>
	<input id="bbps_used_status" name="_bbps_used_status_3" <?php checked( bbps_is_not_support_enabled(),1 ); ?> type="checkbox"  value="1" />
	<label for="_bbps_used_status_3"><?php _e( 'Not a support question', 'bbpress' ); ?></label>
<?php
}

function bbps_admin_setting_callback_permission_admin(){
?>
	<input id="bbps_status_permissions" name="_bbps_status_permissions_admin" <?php checked( bbps_is_admin_enabled(),1 ); ?> type="checkbox"  value="1" />
	<label for="_bbps_status_permissions_admin"><?php _e( 'Allow the admin to update the topic status (recommended).', 'bbpress' ); ?></label>
<?php
}

function bbps_admin_setting_callback_permission_user(){
?>
	<input id="bbps_status_permissions" name="_bbps_status_permissions_user" <?php checked( bbps_is_user_enabled(),1 ); ?> type="checkbox"  value="1" />
	<label for="_bbps_status_permissions_user"><?php _e( 'Allow the person who created the topic to update the status.', 'bbpress' ); ?></label>
<?php
}

function bbps_admin_setting_callback_permission_moderator(){
?>
	<input id="bbps_status_permissions" name="_bbps_status_permissions_moderator" <?php checked( bbps_is_moderator_enabled(),1 ); ?> type="checkbox"  value="1" />
	<label for="_bbps_status_permissions_moderator"><?php _e( 'Allow the forum moderators to update the post status.', 'bbpress' ); ?></label>
<?php
}
...
?>
	...
	<label for="_bbps_enable_topic_move"><?php _e( 'Allow the forum moderators and admin to move topics to other forums.', 'bbpress' ); ?></label>
<?php
}

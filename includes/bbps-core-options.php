...
function bbps_is_trusted_tag_enabled(){
	return get_option( '_bbps_enable_trusted_tag' );
}

function bbps_is_resolved_enabled(){
	return get_option( '_bbps_used_status_1' );
	//return $options['res'];
}

function bbps_is_not_resolved_enabled(){
	return get_option( '_bbps_used_status_2' );
	//return $options['notres'];
}

function bbps_is_not_support_enabled(){
	return get_option( '_bbps_used_status_3' );
	//return $options['notsup'];
}

function bbps_is_moderator_enabled(){
	return get_option( '_bbps_status_permissions_moderator' );
	//return $options['mod'];	
}

function bbps_is_admin_enabled(){
	return get_option( '_bbps_status_permissions_admin' );
	//return $options['admin'];	
}

function bbps_is_user_enabled(){
	return get_option( '_bbps_status_permissions_user' );
	//return $options['user'];	
}
